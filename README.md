...
```bash
curl -sL https://raw.githubusercontent.com/baurzhan/hassio-installer/master/hassio_install.sh | bash -s
```
...
```bash
curl -sL https://raw.githubusercontent.com/baurzhan/hassio-installer/master/hassio_install.sh | bash -s -- -m MY_MACHINE
```
